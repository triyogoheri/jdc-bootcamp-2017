...
import com.agit.jdc.bootcamp.shared.object.Modul;
...
public class CommonViewModel {
    ...
    public static void viewReport(String reportName, FileReport fileReport, Window window, Object... varargs) {
        Map<String, Object> params = new HashMap<>();
        params.put("reportName", reportName);
        params.put("fileReport", fileReport);
